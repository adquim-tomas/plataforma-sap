    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-baseline justify-between border-b border-border-strong pb-3">
        <div>
          ...
          <h1 className="mt-1 text-lg font-medium">Log de Precios</h1>
          <p className="mt-1 text-[0.82rem] text-muted-foreground">
            Historial de precios por cliente/artículo: alta de logs, agregado de líneas con precios nuevos, y eliminación de logs.
          </p>
        </div>
        <Button
          variant="link"
