...
const PATH = "/uploads/orden-compra"
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-baseline justify-between border-b border-border-strong pb-3">
        <div>
          <Label>compras · proveedores</Label>
          <h1 className="mt-1 text-lg font-medium">Orden de Compra</h1>
          <p className="mt-1 text-[0.82rem] text-muted-foreground">
            Generación masiva de órdenes de compra a proveedores. Cada fila del Excel se convierte en un documento SAP.
          </p>
        </div>
        <Button
          variant="link"
